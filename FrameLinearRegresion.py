...
axis[0,2].scatter(range(len(X_test)), Y_test, label = 'y_test')
axis[0,2].scatter(range(len(X_test)), Y_pred, label = 'yfit_test')
...
#varianza(?)
axis[1,2].scatter(range(len(X_train)), Y_train, label = 'Real data')
axis[1,2].scatter(range(len(X_train)), Y_pred_train , color='orange', label = 'Predicted data')
